...
public class OrangeHRMSteps extends BrowserUtils {
    ...
    @Then("The user wants to go yo Admin page")
    public void the_user_wants_to_go_yo_admin_page() {
     admin.setAdminModule();
    }
    @Then("The user wants to go Nationalities section")
    public void the_user_wants_to_go_nationalities_section() {
        staticWait(2);
      admin.setNationalitiiesSection();
    ...
    public void the_user_wants_to_login_orange_hrm_with_excel() throws IOException {
     String filePath="/Users/ahmetaslanoglu/IdeaProjects/cucumberBDD/src/test/resources/Book1.xlsx";
