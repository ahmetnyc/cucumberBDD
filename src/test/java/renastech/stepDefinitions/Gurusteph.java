...
public class Gurusteph extends BrowserUtils {
 ...
 Guruhome guruhome = new Guruhome();
    ...
    public void the_user_wants_to_add_a_customer() {
       guruhome.setAddcustomer();
    }
    @Then("The users wants to verify {string} header")
    public void the_users_wants_to_verify_header(String Header) {
       guruhome.setLogo(Header);
    guruhome.setVerifymessage(Header);
    }
    @Then("The user wants to enter background check as {string}")
    public void the_user_wants_to_enter_background_check_as(Map<String,String> datatable) {
    guruhome.setDone();
    guruhome.setName(datatable.get("Joe"));
    guruhome.setLastName(datatable.get("Dave"));
    }
    @Then("The user wants to enter billingaddress as {string} and {string} and {string} and {string} and {string}")
    public void the_user_wants_to_enter_billingaddress_as_and_and_and_and() {
    }
